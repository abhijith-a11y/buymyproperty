...
document.addEventListener("DOMContentLoaded", function () {
    ...
    accordions.forEach((header, index) => {
        header.addEventListener("click", function (e) {
            ...
            if (!isActive && content && content.classList.contains('accordion_content')) {
...
function initializeProductSwiper() {
    ...
    if (typeof Swiper === 'undefined') {
        console.error('❌ Swiper library not found. Product Swiper cannot initialize.');
        return false;
    }
    ...
    try {
        ...
        console.log('✅ Product Swiper initialized successfully with RTL support:', isRTL);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    setTimeout(function () {
        if (typeof Swiper !== 'undefined') {
            ...
            console.warn('⚠️ Swiper not ready yet for Product Swiper, will try again...');
...
function initRecentlyClosedDealsSwiper() {
    ...
    console.log('✅ Recently closed deals slider initialized with Swiper');
}
...
function initWhySellSwiper() {
    ...
    function updateIndicatorPosition(activeIndex) {
        if (indicatorLine) {
            ...
            console.log(`🎯 Indicator updated: slide ${activeIndex + 1}/4, translateY: ${activeIndex * 25}%`);
        }
    }
...
function initThreeStepSwiper() {
    ...
    console.log('✅ Three Step Process slider initialized with responsive breakpoints');
}
...
function initializeBuiltOnTrustAnimation() {
    ...
    if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
        console.log('❌ GSAP or ScrollTrigger not available for Built on Trust animation');
        return;
    }
    ...
    console.log('✅ Built on Trust ScrollTrigger animation initialized with translateY animation');
}
...
function initializeMadeDifferenceSlider() {
    const madeDifferenceSwiper = document.querySelector('.made-difference-swiper');
...
function customeDropdown () {
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                ...
                const formData = {
                    ...
                    location: document.querySelector('[data-dropdown="location"]').getAttribute('data-selected'),
                    discuss: document.querySelector('[data-dropdown="discuss"]').getAttribute('data-selected'),
                    propertyType: document.querySelector('[data-dropdown="propertyType"]').getAttribute('data-selected'),
                    meetingFormat: document.querySelector('[data-dropdown="meetingFormat"]').getAttribute('data-selected'),
                    dateTime: document.querySelector('[data-dropdown="dateTime"]').getAttribute('data-selected'),
...
function initializeCareerApplyModal() {
    const modal = document.getElementById('careerApplyModal') || document.querySelector('.career-apply-modal');
    if (!modal) {
