    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-right overlay-1">
              ...
              <div class="hero-background" style="background-image:url(<?php if(get_field('hm_bnr_image')){ echo get_field('hm_bnr_image')['url']; }?>);">
                ...
                <?php if( have_rows('marquee_items') ): ?>
                    ...
                    <div class="swiper-slide">
                        <div class="marquee-content">
                            <?php while( have_rows('marquee_items') ) : the_row(); 
                    ...
                    <div class="swiper-slide">
                        <div class="step-card-container">
                            ...
                            <div class="step-text-card">
                                ...
                                <div class="step-number"><?php echo str_pad($step_counter, 2, '0', STR_PAD_LEFT); ?></div>
            ...
            <div class="why-sell-slider-container">
                <div class="swiper why-sell-swiper">
                    <div class="swiper-wrapper">
                        <?php 
                        $slide_index = 0;
                        while( have_rows('hm_ws_why_sell_to_us') ): the_row(); 
            ...
            <div class="why-sell-pagination">
                <div class="pagination-numbers">
                    <?php for( $i = 0; $i < $total_slides; $i++ ): ?>
                        <span class="pagination-number <?php echo $i === 0 ? 'active' : ''; ?>" data-slide="<?php echo $i; ?>">
                ...
                <div class="deals-navigation">
                    <div class="swiper-button-prev deals-prev">
                        <svg width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.88452 0.880798L9.19988 5.00001L4.88452 9.11922" stroke="black" stroke-width="1.28571" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M9.2 4.99994L0.800049 4.99994" stroke="black" stroke-width="1.28571" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
...
<section class="referral-banner container" style="background: url('<?php echo get_field('hm_bg_referal_image')['url']; ?>') right center / cover no-repeat;">
    <div class="text-content">
        ...
        <a href="<?php echo get_field('hm_re_button')['url']; ?>" class="btn-primary">
            ...
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.88452 0.880798L9.19988 5.00001L4.88452 9.11922" stroke="white" stroke-width="1.28571" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M9.2 4.99994L0.800049 4.99994" stroke="white" stroke-width="1.28571" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </a>
        <?php endif; ?>
    </div>
