            ...
            <div class="footer-left">
                ...
                <div class="footer-top">
                    ...
                    <div class="footer-brand">
                        <div class="footer-logo">
                            ...
                            <a href="<?php echo home_url('/'); ?>"><img src="<?php echo get_field('footer_logo', 'option')['url']; ?>"  alt="<?php bloginfo('name'); ?>" class="footer-brand-logo"></a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="footer-social">
                            ...
                            ?>
                                <a href="<?php echo esc_url($url); ?>" class="social-link " target="_blank" rel="noopener" aria-label="<?php echo esc_attr($url); ?>">
                ...
                <div class="footer-bottom">
                    <div class="footer-copyright">
                            <p class="text-body-regular text-muted"><?php echo str_replace('{year}',date('Y'),get_field('copyright_text', 'option')); ?></p>
            ...
            <!-- Right Section: CTA -->
              <div class="footer-right">
                <div class="footer-cta-content">
                    <h3 class="heading-medium-accent text-accent font-medium"><?php echo get_field('sell_title', 'option'); ?></h3>
                    <?php if(get_field('sell_link', 'option')): ?>
                    <a href="<?php echo get_field('sell_link', 'option')['url']; ?>" class="btn-primary footer-cta-btn"><?php echo get_field('sell_link', 'option')['title']; ?>
