...
<form class="property-form" id="heroContactForm" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" enctype="multipart/form-data" novalidate>
    ...
    <div class="form-step" data-step="1" style="display: block;">
        ...
        <div class="form-row-3">
            <div class="form-group">
                <input type="text" name="community_area" id="community-area" list="community-list" placeholder="Select an Emirate first" required autocomplete="off">
            ...
            <input type="file" name="property_images[]" id="property_images" multiple accept="image/*">
                <div class="upload-button">
                    ...
                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M8.31343 1V15.0136M1.30664 8.00679H15.3202" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    </span>
                </div>
                <script>
    ...
    <div class="form-step success-step" data-step="4" style="display: none;">
        <div style="text-align: center; padding: 40px 20px;">
            ...
            <button type="button" class="btn-primary footer-cta-btn" onclick="location.reload();" style="margin-top: 20px;">
