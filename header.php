        ...
        <!-- Mobile Header (visible below 820px) -->
            <div class="mobile-header">
                <div class="wrap mobile-header__inner">
                    ...
                    <div class="d_flex g_1"> <a href="<?php echo home_url(); ?>"
                            class="btn btn-white">Get an Offer</a>
            ...
            <div class="site-header">
                    ...
                    <div class="site-header__top wrap">
                       ...
                       <nav class="site-header__nav">
                                <?php if( have_rows('top_navigation_menus', 'option') ): ?>
                                    ...
                                    ?>
                                    <?php while( have_rows('top_navigation_menus', 'option') ): the_row(); 
                ...
                <div class="site-header__bottom wrap">
                    <div class="site-header__logo">
                        ...
                        <img class="logo"
                            src="<?php echo get_field('h_logo', 'option')['url']; ?>"
                    ...
                    <div class="site-header__actions">
                        ...
                        <a href="<?php echo get_field('h_button', 'option')['url']; ?>" class="btn btn-white"><?php echo get_field('h_button', 'option')['title']; ?></a>
                        <?php endif; ?>
                ...
                <div class="main-content wrap">
                  <?php if( have_rows('h_main_menus_', 'option') ): ?>
                        <ul class="main-nav">
                            <?php 
                            $count = 1;
                            while( have_rows('h_main_menus_', 'option') ): the_row(); 
                            ...
                            ?>
                                <li class="nav-item <?php echo $is_dropdown ? 'has-dropdown' : ''; ?>">
                                    ...
                                    <?php if( $is_dropdown && have_rows('h_sub_menus') ): ?>
                                        <div class="submenu">
                                            <?php while( have_rows('h_sub_menus') ): the_row(); 
                   ...
                   <?php if( have_rows('social_links', 'option') ): ?>
                    ...
                    <div class="right-section">
                        <div class="footer-cta-content">
                            <h3 class="heading-medium-accent text-accent font-medium"><?php echo get_field('h_box_title', 'option'); ?></h3>
                            <?php   if(get_field('h_box_link', 'option')): ?>
                            <a href="<?php echo get_field('h_box_link', 'option')['url']; ?>" class="btn-primary footer-cta-btn">
